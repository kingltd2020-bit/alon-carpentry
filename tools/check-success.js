/* ============================================================
   ...
   check.js בודק רק מה שקורה כשהשליחה נכשלת, כי WEBHOOK_URL
   ריק בקוד. הקובץ הזה בודק את הצד השני: מה נשלח ב-payload,
   ומה קורה בדף אחרי תשובה תקינה.

   הרצה: להחליף את WEBHOOK_URL בערך כלשהו, ואז לצרף את הקובץ.
   הפירוט ב-README של התיקייה הזו.
   ============================================================ */
(async function () {
